const Contacts = () => {
  return (
      ...
      <div className="justify-center flex-1 max-w-5xl px-4 mx-auto md:px-7">
          <div className="max-w-xl mx-auto">
              <div className="text-center ">
                  <div className="relative flex flex-col items-center">
                      ...
                      <h1 className="text-5xl font-bold"> Наши<span className="text-red-500"> контакты</span> 
                      </h1>
          ...
          <div className="flex flex-wrap mb-8 -mx-4">
              <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                  <div
                      ...
                      <div
                          className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-red-500 rounded-full">
              ...
              <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                  <div
                      ...
                      <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                          Телефон</h2>
                      <a href="#"
                          className="text-base font-medium text-gray-500 md:text-lg">+9876542312</a>
                  </div>
              </div>
              <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                  <div
                      ...
                      <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                          Социальные сети</h2>
                      <a href="#"
                          className="inline-block mr-4 text-red-600 hover:text-red-700">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      ...
                      <a href="#"
                          className="inline-block mr-4 text-red-400 hover:text-red-600">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      ...
                      <a href="#"
                          className="inline-block mr-4 text-red-500 hover:text-red-600">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <form action="">
                  <div className="mb-6">
                      <h2 className="text-xl font-bold text-gray-00">
                          Задайте вопрос и мы поможем вам с выбором! </h2>
                  </div>
                  <div className="flex flex-wrap mb-4 -mx-2">
                      <div className="w-full px-2 mb-4 lg:mb-0 lg:w-1/2">
                          <input className="w-full px-3 py-2 leading-loose border rounded-md bg-gray-50" type="text" placeholder="Имя.." required=""></input>
                      </div>
                  ...
                  <input
                      ...
                      type="email" placeholder="abc@gmail.com" required=""></input>
                  <textarea rows="4" type="message" placeholder="Ваше сообщение..." required=""
                      className="block w-full px-4 mb-4 leading-tight text-gray-700 border rounded bg-gray-50 py-7 "></textarea>
                  <button
